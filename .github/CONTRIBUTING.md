# Contributing to LeekHub LeekFund

## Code of Conduct

LeekFund has adopted the [Contributor Covenant](https://www.contributor-covenant.org/) as its Code of Conduct, and we expect project participants to adhere to it.
...
If you have questions about LeekHub LeekFund, be sure to check out the docs where we have several examples and detailed API references that may help you solve your problem. You can also share your questions on [GitHub Discussions](https://github.com/LeekHub/leek-fund/discussions).
...
- **Support.** You can answer questions on StackOverflow or [GitHub Discussions](https://github.com/LeekHub/leek-fund/discussions), or provide solutions for others in [open issues](https://github.com/LeekHub/leek-fund/issues).
- **Write.** If you come up with an interesting example, write about it. Post it to your blog and share it with us. We'd love to see what folks in the community build with LeekFund!
- **Report.** Create issues with bug reports so we can make LeekFund even better.
...
8. Go to [the repository](https://github.com/LeekHub/leek-fund) and [make a Pull Request](https://docs.github.com/en/free-pro-team@latest/github/collaborating-with-issues-and-pull-requests/creating-a-pull-request).
